...
% Empirical
htc1 = (k1*rho1/xLength/2.)*0.332*ReX1^0.5*Pr1^(1./3.); 
...
htc2 =(k2*rho2/xLength/2.)*0.332*ReX2^0.5*Pr2^(1./3.); 

%% Load simulation data
topAirT0 = 1800;
topAirT = dlmread('./dataFiles/pgf03/postProcessing/pp0/topAir/4.91/T', '', 3);
% topAirT = dlmread('./dataFiles/pgf04/postProcessing/pp0/topAir/7.19/T', '', 3);

bottomAirT0 = 300;
bottomAirT = dlmread('./dataFiles/pgf03/postProcessing/pp1/bottomAir/4.91/T', '', 3);
% bottomAirT = dlmread('./dataFiles/pgf04/postProcessing/pp1/bottomAir/7.19/T', '', 3);


%% Compute the correlation equations
eq1 = htc1*(topAirT0 - topAirT(:, 2))
